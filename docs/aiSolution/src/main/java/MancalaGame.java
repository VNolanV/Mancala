...
public class MancalaGame {
    ...
    public MancalaGame() {
        board = new int[14]; // 0-5: Player 1's pits, 7-12: Player 2's pits, 6: Player 1's Mancala, 13:
                             // Player 2's Mancala
    ...
    private void distributeStones(int pitIndex) {
        ...
        } else if (currentPlayer == 2 && currentPit > 6 && currentPit < 13 && board[currentPit] == 1
                && board[12 - currentPit] > 0) {
    ...
    private void printResult() {
        ...
        if (player1Score == player2Score) {
            ...
            System.out.println("Player " + ((player1Score > player2Score) ? "1" : "2") + " wins with "
                    + Math.max(player1Score, player2Score) + " points!");
        }
    }
